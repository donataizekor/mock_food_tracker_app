...
/**
 * activity displays items from Firestore which are labelled as freezer
 */

private const val TAG = "FreezerActivity"
class FreezerActivity : ItemActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //query for items labelled as freezer
        val typeReference = itemReference
            .whereEqualTo("type", "freezer")
