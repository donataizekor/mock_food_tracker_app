...
/**
 * activity displays items from Firestore which are labelled as counter
 */

private const val TAG = "CounterActivity"

class CounterActivity : ItemActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //query for items labelled as counter
        val typeReference = itemReference
                .whereEqualTo("type", "counter")
