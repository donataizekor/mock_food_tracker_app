...
/**
 * activity displays items from Firestore which are labelled as pantry
 */

private const val TAG = "PantryActivity"

class PantryActivity : ItemActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //query for items labelled as pantry
        val typeReference = itemReference
            .whereEqualTo("type", "pantry")
